...
import {
  Mail, Phone, MapPin, Send, Clock, MessageCircle, ChevronDown, ChevronUp,
} from 'lucide-react'
...
const ContactPage: React.FC = () => {
  ...
  const contactCards = [
		...
		},
		{
			icon: <Phone size={24} />,
			title: "Call Us",
			value: "+1(262) 362-1810",
			sub: "Mon–Fri, 9am–6pm EST",
			href: "tel:+1(262) 362-1810",
			color: "#9B30FF",
		},
		{
			icon: <MapPin size={24} />,
			...
			<section
				...
				<div
					style={{
						...
						borderRadius: "50%",
						background:
							"radial-gradient(circle, rgba(230,91,168,0.12), transparent 70%)",
						pointerEvents: "none",
					}}
				/>
				<div
					...
					<p
						...
						Questions, feedback, collabs, or just
						want to say hi? We're always here for
						our community. Drop us a message!
					</p>
				</div>
			</section>
							...
							<div
								...
								<div>
									...
									<p
										...
										No bots here! Every message is
										personally read and responded
