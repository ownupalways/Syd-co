				...
				<div
					style={{
						...
						background: isDark
							...
							: "radial-gradient(circle, rgba(230,91,168,0.2), transparent 70%)",
						pointerEvents: "none",
					}}
				/>
				<div
					style={{
						...
						borderRadius: "50%",
						background: isDark
							? "radial-gradient(circle, rgba(155,48,255,0.08), transparent 70%)"
							: "radial-gradient(circle, rgba(255,182,217,0.4), transparent 70%)",
						pointerEvents: "none",
					}}
				/>
				...
				<div
					...
					<div>
						...
						<p
							...
							Shop the latest beauty & fashion
					...
					<div
						...
						<img
							...
							style={{
								...
								objectFit: "contain",
								filter: isDark
									? "drop-shadow(0 20px 60px rgba(230,91,168,0.3))"
									: "drop-shadow(0 20px 60px rgba(230,91,168,0.2))",
								animation:
