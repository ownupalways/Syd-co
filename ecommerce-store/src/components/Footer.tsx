		...
		<footer
			...
			<div
				style={{
					...
					padding:
						"clamp(32px, 6vw, 48px) clamp(16px, 5vw, 24px)",
				}}>
				<div
					style={{
						maxWidth: 600,
				...
				<div
					...
					<div>
						...
						<p
							...
							Your favorite destination for
							quality beauty & fashion products.
						</p>
